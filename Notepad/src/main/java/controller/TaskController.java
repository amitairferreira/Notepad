...
//1-vou criar 4 métodos, um pra cada operaç básica que eu quero que tarefas faça.
...
//deletar tarefa
    public void removeById(int taskId) {
        ...
        try {
            ...
            connection = ConnectionFactory.getConnection();//pedi a conexão
...
//buscar todas as tarefas com base no projeto   
    public List<Task> getAll(int idProject) {
        ...
        try {
            ...
            //Enquanto houverem valores  a serem percorridos no meu resultSet faça
